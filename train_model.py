...
# Set training device (GPU if available, otherwise CPU)
local_rank = -1
fp16 = False
if local_rank == -1:
...
# Convert patient visits and labels into batched tensors for HALO
...
# Initialize HALO model and Adam optimizer
